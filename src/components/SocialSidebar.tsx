...
const links = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61570963028733",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/sovereignwaycleaners/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-6 h-6">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/sovereign-way-cleaners/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-6 h-6">
  ...
  {
    label: "WhatsApp",
    href: "https://api.whatsapp.com/send/?phone=447898145067",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-6 h-6">
...
export default function SocialSidebar() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      // Only the middle ~10 % of the viewport triggers the switch
